...
public class Order_Item {
	...
	//Konstruktori pa parametra i modelit Order_Item
	public Order_Item() {}
	...
	public String toString() {
		return "Order_item_id eshte: " + order_item_id + "ka kete item_id: " +item_id+ "dhe sasia ne porosi eshte: "+quantity+"dhe ka cmim:"+ unit_price + ". ";
	}
