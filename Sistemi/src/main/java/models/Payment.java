...
public class Payment {
	...
	//Konstruktori pa parametra i modelit Payment 
	public Payment() {}
	...
	public String toString() {
		return "Pagesa ka id: " +payment_id+" ka item: "+item_id+" me order id: "+order_id+"me sasi "+quantity+"dhe cmim produkti"+unit_price+" .";
	}
